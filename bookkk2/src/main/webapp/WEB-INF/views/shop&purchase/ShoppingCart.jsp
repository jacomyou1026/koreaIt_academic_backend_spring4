...
<body>
	...
	<div class="mainbox">
		...
		<main>
			<ul class="normalpayfrmae">
				<li><input class="normalpay" type="button" value="일반구매">
				</li>
			</ul>
			<!--총 cart에 몇개 있는지  -->
							...
							<td
								...
								<div class="div_flex">
									...
									<div class="cart_info">
										...
										<!-- 책 가격 -->
										<input type="text" class="bookprice_input" value="${vo.price}">
										<!-- 책 수량 -->
										...
										<input type="text"  class="individual_subject" value="${vo.subject}">
									</div>
	...
	<!-- 주문 form -->
	<form action="purchase.do" method="get" class="order_form">
