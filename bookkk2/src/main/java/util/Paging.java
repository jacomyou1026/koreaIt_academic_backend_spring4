...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			...
			sb.append("'><img src='/controller/resources/page_img/btn_prev.gif'></a>");
		}
		else
			sb.append("<img src='/controller/resources/page_img/btn_prev.gif'>");
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(nowPage);*/
			sb.append("'><img src='/controller/resources/page_img/btn_next.gif'></a>");
		}
		else
			sb.append("<img src='/controller/resources/page_img/btn_next.gif'>");
//---------------------------------------------------------------------------------------------------------------------	    
