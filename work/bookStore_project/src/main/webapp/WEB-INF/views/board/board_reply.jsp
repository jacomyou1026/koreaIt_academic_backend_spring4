...
<title>Insert title here</title>
	<script>
		function send_check(){
			...
			//reply.do?idx=1&subject=제목&name=작성자명&content=내용&pwd=1111
				f.submit();
		}
	</script>
...
<body>
	<h1 align="center">:::댓글작성:::</h1>  
	<form name="ff" id="f" method="post" action="reply.do">
		
		<!-- hidden으로 넘어온 idx값을 param으로 받을 수 있다 post로 넘어와서 확인해보면 좋음 -->
		<!-- 댓글을 달고싶은 게시물 번호와 페이지 -->
