...
/* 		window.onload=function(){
		...
		function testApi(){
			var url="https://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey=ttbskgusslarj1715002&QueryType=ItemNewAll&MaxResults=100&start=1"+
					"&SearchTarget=Foreign&output=js&Version=20131101&Cover=Big&outofStockfilter=1&CategoryId=97539";
			var param="";
		...
		function resultFn(){
			...
			if(xhr.readyState==4 && xhr.status==200){
				...
				var subject =json[0].item[6].title;
				var author =json[0].item[6].author;
				var publishDate =json[0].item[6].pubDate;
				var stock =json[0].item[6].stockStatus;
				var categoryNum =json[0].item[6].categoryId;
				var publisher =json[0].item[6].publisher;
				var img = json[0].item[6].cover;
				var price =json[0].item[6].priceStandard;
				var intro =json[0].item[6].description;
...
<body>
	...
	<button type="button" onclick="location.href='bookList2?c=200000&t=1';">외국도서확인하기</button>
	<button type="button" onclick="location.href='bookListNew?c=300000&t=1';">신간도서확인하기</button>
	<button type="button" onclick="location.href='bookListBest?c=400000&t=1';">베스트셀러도서확인하기</button>		
	<script>
